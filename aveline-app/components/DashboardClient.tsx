...
/* ─── Quick-action tiles ─────────────────────────────────────────────────── */
const ACTIONS = [
  { icon: QrCode,       label: "Scan product",   href: "/scan",          bg: "#EFF5EE", color: "#304C3A" },
  { icon: BookOpen,     label: "Recepten",        href: "/content",       bg: "#E8F2E8", color: "#304C3A" },
  { icon: ShoppingBag,  label: "Bestellen",       href: "/orders",        bg: "#EFF5EE", color: "#304C3A" },
  { icon: MapPin,       label: "Winkels",         href: "/locations",     bg: "#E8F2E8", color: "#304C3A" },
  { icon: MessageCircle,label: "Support",         href: "/chat",          bg: "#EFF5EE", color: "#304C3A" },
  { icon: Users,        label: "Community",       href: "/community",     bg: "#E8F2E8", color: "#304C3A" },
] as const;
    ...
    <div className="mobile-shell">
      ...
      <div className="flex-1 overflow-y-auto">
        <div className="px-6 py-6 flex flex-col gap-8">
          ...
          >
            <div>
              <p className="text-xs font-medium mb-1" style={{ color: "#BDD2B7" }}>
                Nieuw product?
              </p>
