...
import { AlertCircle, MessageCircle, ChevronRight, Bell } from "lucide-react";
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto px-5 pb-6">
        ...
        <div className="flex flex-col gap-3">
          {[
            { label: "Klachten beheren",  href: "/dashboard/klachten", icon: AlertCircle,    bg: "#EFF5EE" },
            { label: "Chat met klanten",  href: "/dashboard/chat",     icon: MessageCircle,  bg: "#E8F2E8" },
